        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item {{ request()->routeIs('propertytype.index') || request()->routeIs('property.index') || request()->routeIs('wards.index') || request()->routeIs('propertydetails.index') || request()->routeIs('department.index') || request()->routeIs('slot.index') || request()->routeIs('adhaardetail.index') ? 'active' : '' }}">
                    ...
                    <div class="collapse menu-dropdown {{ request()->routeIs('propertytype.index') || request()->routeIs('property.index') || request()->routeIs('wards.index') || request()->routeIs('propertydetails.index') || request()->routeIs('department.index') || request()->routeIs('slot.index') || request()->routeIs('adhaardetail.index') ? 'show' : '' }}" 
                         id="mastersDropdown">
                ...
                <li class="nav-item {{ request()->routeIs('users.index') || request()->routeIs('roles.index') ? 'active' : '' }}">
                    ...
                    <div class="collapse menu-dropdown {{ request()->routeIs('users.index') || request()->routeIs('roles.index') ? 'show' : '' }}" 
